...
def show_coding_demo():
    st.header("Coding Demo")
    st.subheader("ESP8266 Arduino Code")

    st.write("Below is the Arduino code for ESP8266.")
    ...
    st.subheader("Arduino Code for SOS Calling System")

    st.write("Below is the Arduino code for SOS calling system.")
